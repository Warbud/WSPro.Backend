...
namespace Test.WSPro.Backend.Infrastructure.ProjectTest
{
    ...
    public class TestSingleElement
    {
        ...
        private readonly List<Project> _projectsDB = new();
        ...
        private static object[][] _projectCases =
        {
            new object[]
            {
                ...
                new Project("project with name")
                    { WebconCode = null, MetodologyCode = null, CentralScheduleSync = false }
            },
            new object[]
            {
                new Project("project with all params", "webcon", "metodology"),
                new Project("project with all params")
                    { WebconCode = "webcon", MetodologyCode = "metodology", CentralScheduleSync = false }
            },
            new object[]
            {
                new Project("project with all params and centralScheduleSync as true", "webcon", "metodology", true),
                new Project("project with all params and centralScheduleSync as true")
                    { WebconCode = "webcon", MetodologyCode = "metodology", CentralScheduleSync = true }
            },
            new object[]
            {
                new Project("project with empty metodology code", "webcon", "", true),
                new Project("project with empty metodology code")
                    { WebconCode = "webcon", MetodologyCode = null, CentralScheduleSync = false }
            },
            new object[]
            {
                new Project("project with metodology code as null", "webcon", null, true),
                new Project("project with metodology code as null")
                    { WebconCode = "webcon", MetodologyCode = null, CentralScheduleSync = false }
            },
            new object[]
            {
                new Project("project with webcon code as empty string", "", "metodology", true),
                new Project("project with webcon code as empty string")
                    { WebconCode = null, MetodologyCode = "metodology", CentralScheduleSync = false }
            },
            new object[]
            {
                new Project("project with webcon code as null", null, "metodology", true),
                new Project("project with webcon code as null")
                    { WebconCode = null, MetodologyCode = "metodology", CentralScheduleSync = false }
            }
        };
